    ...
    <div className="bg-black text-white p-4">
        ...
        <div className="flex justify-between">
            ...
            <div className="basis-[10%] flex flex-col gap-6">
                ...
                <a href="#career" className="text-gray-400 hover:text-white">Career</a>
            </div>
            {/* middle 2  */}
            <div className="basis-[10%] flex flex-col gap-6">
            ...
            <div className="basis-[30%]">
              ...
              <div className="flex gap-8 mt-6 ml-4">
                ...
                <img src={tiktok} alt=""  className="w-8 h-8 cursor-pointer" />
              </div>
            </div>
        </div>
